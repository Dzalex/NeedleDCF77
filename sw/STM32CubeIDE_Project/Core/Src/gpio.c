...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, SHDN_24V_Pin|LTC_CHRG_Pin|LTC_MODE_Pin|LTC_HPWR_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = SHDN_24V_Pin|LTC_CHRG_Pin|LTC_MODE_Pin|LTC_HPWR_Pin;
